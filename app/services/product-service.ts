export class Product {
    constructor(
        ...
        public categories: Array<string>) { //changed to string[] in Ch4!!
    }
}
...
export class ProductService {
    ...
    getProductById(productId: number): Product {
        console.log('productId=',productId);//should check for NaN!!!
        //return products.filter(p => p.id === productId)[0];//What if empty list? - returns 'undefined'. Could do better!
        return products.find(p => p.id === productId);//What if empty list? - returns 'undefined'. Could do better!
    }
